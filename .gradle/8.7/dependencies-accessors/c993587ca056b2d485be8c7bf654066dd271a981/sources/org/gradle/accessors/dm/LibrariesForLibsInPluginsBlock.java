...
public class LibrariesForLibsInPluginsBlock extends AbstractExternalDependencyFactory {
    ...
    public static class AndroidxLibraryAccessors extends SubDependencyFactory {
         ...
         * with version reference <b>cardView.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
         ...
         * with version reference <b>recycler.version</b>
         * <p>
         * This dependency was declared in catalog libs.versions.toml
         *
         * @deprecated Will be removed in Gradle 9.0.
    ...
    public static class VersionAccessors extends VersionFactory  {
        ...
        private final CardViewVersionAccessors vaccForCardViewVersionAccessors = new CardViewVersionAccessors(providers, config);
        ...
        private final RecyclerVersionAccessors vaccForRecyclerVersionAccessors = new RecyclerVersionAccessors(providers, config);
        ...
        /**
         * Group of versions at <b>versions.cardView</b>
         */
        public CardViewVersionAccessors getCardView() {
            return vaccForCardViewVersionAccessors;
        }

        /**
         * Group of versions at <b>versions.glide</b>
         */
        ...
        /**
         * Group of versions at <b>versions.recycler</b>
         */
        public RecyclerVersionAccessors getRecycler() {
            return vaccForRecyclerVersionAccessors;
        }
    ...
    public static class CardViewVersionAccessors extends VersionFactory  {

        public CardViewVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>cardView.version</b> with value <b>1.0.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("cardView.version"); }
    ...
    public static class GlideVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>glide.version</b> with value <b>4.16.0</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class KspVersionAccessors extends VersionFactory  {
        ...
        /**
         * Version alias <b>ksp.version</b> with value <b>2.0.21-1.0.25</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
    ...
    public static class RecyclerVersionAccessors extends VersionFactory  {

        public RecyclerVersionAccessors(ProviderFactory providers, DefaultVersionCatalog config) { super(providers, config); }

        /**
         * Version alias <b>recycler.version</b> with value <b>1.3.2</b>
         * <p>
         * If the version is a rich version and cannot be represented as a
         * single version string, an empty string is returned.
         * <p>
         * This version was declared in catalog libs.versions.toml
         */
        public Provider<String> getVersion() { return getVersion("recycler.version"); }
    ...
    public static class AndroidPluginAccessors extends PluginFactory {
        ...
        /**
         * Plugin provider for <b>android.ksp</b> with plugin id <b>com.google.devtools.ksp</b> and
         * with version reference <b>ksp.version</b>
         * <p>
         * This plugin was declared in catalog libs.versions.toml
         */
        public Provider<PluginDependency> getKsp() { return createPlugin("android.ksp"); }
